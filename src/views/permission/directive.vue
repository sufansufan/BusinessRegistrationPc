<template>
  <div class="app-container">
    ...
    <div :key="key" style="margin-top:30px;">
      <div>
        <span v-permission="['admin']" class="permission-alert">Only
      ...
      <div>
        <span v-permission="['editor']" class="permission-alert">Only
      ...
      <div>
        <span v-permission="['admin','editor']" class="permission-alert">Both
    ...
    <div :key="'checkPermission'+key" style="margin-top:60px;">
      ...
      <el-tabs type="border-card" style="width:550px;">
        <el-tab-pane v-if="checkPermission(['admin'])" label="Admin">Admin can see this
          <el-tag class="permission-sourceCode" type="info">v-if="checkPermission(['admin'])"</el-tag>
        </el-tab-pane>

        <el-tab-pane v-if="checkPermission(['editor'])" label="Editor">Editor can see this
