  ...
  data() {
    return {
      ...
      columns: [
        ...
        { label: '调出课次', prop: 'classSequence' },
        { label: '课次日期', prop: 'classSequence' },
        { label: '目标班级名称', prop: 'classSequence', width: '300' },
        ...
        { label: '调入课次', prop: 'aciUpdateByName' },
        { label: '课次日期', prop: 'aciUpdateByName' },
